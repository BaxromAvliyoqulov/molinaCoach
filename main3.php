				...
				<div class="row">
					<div class="col">
						<div class="col-12 headerTextTest">
							...
							Перед вами список <b>КРИТИЧНО ВАЖНЫХ</b> для вас ценностей.
							Если этих ценностей больше трех, подумайте и отберите <h3 class="d-inline-block">ТОП 3</h3> ценности - так будет проще их запомнить. Если их уже осталось три, выберите все и переходите на итоговую страницу теста.
							</p>
						</div>
					</div>
				</div>
